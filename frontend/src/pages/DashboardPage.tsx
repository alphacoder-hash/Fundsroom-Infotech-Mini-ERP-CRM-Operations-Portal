...
const DashboardPage: React.FC = () => {
  ...
  const statCards = [
    { label: 'Total Customers', value: stats.customers, color: '#6366f1', bg: 'rgba(99,102,241,0.15)', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{color:'#6366f1'}}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg>, path: '/customers' },
    { label: 'Products in Catalog', value: stats.products, color: '#10b981', bg: 'rgba(16,185,129,0.15)', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{color:'#10b981'}}><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>, path: '/products' },
    { label: 'Sales Challans', value: stats.challans, color: '#f59e0b', bg: 'rgba(245,158,11,0.15)', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{color:'#f59e0b'}}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>, path: '/challans' },
    { label: 'Low Stock Alerts', value: stats.lowStock, color: '#ef4444', bg: 'rgba(239,68,68,0.15)', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{color:'#ef4444'}}><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>, path: '/products' },
  ];
